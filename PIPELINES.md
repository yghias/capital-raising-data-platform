...
- [src/ingestion/api_clients.py](src/ingestion/api_clients.py) lands sample market-intelligence payloads into `sample_data/raw_extracts`
- [src/ingestion/crm_client.py](src/ingestion/crm_client.py) lands CRM activity extracts for local workflow validation
- [src/orchestration/airflow_dag.py](src/orchestration/airflow_dag.py) wires ingestion, SQL asset validation, monitoring query checks, and forecasting tasks
